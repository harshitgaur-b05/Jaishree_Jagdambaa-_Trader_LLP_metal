...
const INFO_ITEMS = [
  ...
  },
  {
    icon: '📍',
    label: 'Address',
    value: 'Delhi, India — Pan India delivery available',
    href: null,
  },
];
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
      ...
      <p className="text-xs text-slate-400 text-center">
        This will open WhatsApp with your message pre-filled. No data is stored.
      </p>
    </form>
  );
}
...
export default function ContactPage() {
  return (
    <div className="min-h-screen bg-slate-50">
      {/* Header */}
      <div className="bg-[#0f172a] py-12 px-4 md:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-3">Contact Us</h1>
          <p className="text-slate-400 max-w-lg mx-auto">
            Reach out for pricing, availability, or bulk enquiries. We typically respond within minutes on WhatsApp.
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          ...
          <div className="flex flex-col gap-6">
                    ...
                    <div>
                      ...
                      {href ? (
                        <a
                          ...
                          className="text-sm text-[#0f172a] font-semibold hover:text-[#3b82f6] transition-colors"
                        >
                          {value}
                        </a>
                      ) : (
            ...
            <a
              ...
              className="flex items-center justify-center gap-3 bg-[#25D366] hover:bg-[#1ebe5b] text-white font-bold py-4 rounded-2xl transition-colors text-sm shadow"
            >
          ...
          <div className="bg-white rounded-2xl border border-slate-200 p-6">
            ...
            <p className="text-sm text-slate-500 mb-6">
              Fill out the form below — clicking send will open WhatsApp with your message pre-filled.
            </p>
            <ContactForm />
          </div>
        </div>
