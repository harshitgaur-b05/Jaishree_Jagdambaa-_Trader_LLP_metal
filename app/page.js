...
const CERT_DATA = [
  { title: 'Certificate of Incorporation - LLP', id: 'XXXXX-XXXX', file: 'Certificate of Incorporation LLP.pdf', imgNum: 1 },
  { title: 'GST Registration Certificate', id: '07AAXXXXXXXXXXZ', file: 'GST Certificate LLP.pdf', imgNum: 2 },
  { title: 'Import Export Code (IEC) Certificate', id: 'XXXXXXXXXX', file: 'IMPORT EXPORT CERTIFICATE LLP.pdf', imgNum: 3 },
  { title: 'MSME Registration Certificate', id: 'UDYAM-XX-XX-XXXXXXX', file: 'MSME CERTIFICATE.pdf', imgNum: 4 },
];
...
export default function HomePage() {
  ...
  const WHY_US = [
    { icon: '✅', title: t('why_us.q1_title'), desc: t('why_us.q1_desc') },
    { icon: '🚚', title: t('why_us.q2_title'), desc: t('why_us.q2_desc') },
    { icon: '💰', title: t('why_us.q3_title'), desc: t('why_us.q3_desc') },
    { icon: '🤝', title: t('why_us.q4_title'), desc: t('why_us.q4_desc') },
  ];
  ...
  return (
    <>
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 md:px-8 mt-12 md:mt-20">
          <div className="flex flex-col items-center text-center max-w-5xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center items-center gap-6 text-sm text-white/80 font-medium tracking-wide">
              <span className="flex items-center gap-2"><span className="text-[#007f5f] dark:text-[#10b981] text-lg">✓</span> {t('hero.trust1')}</span>
              <span className="flex items-center gap-2"><span className="text-[#007f5f] dark:text-[#10b981] text-lg">✓</span> {t('hero.trust2')}</span>
              <span className="flex items-center gap-2"><span className="text-[#007f5f] dark:text-[#10b981] text-lg">✓</span> {t('hero.trust3')}</span>
              <span className="flex items-center gap-2"><span className="text-[#007f5f] dark:text-[#10b981] text-lg">✓</span> {t('hero.trust4')}</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#f8f9fa] dark:bg-[#121212] py-16 px-4 md:px-8 transition-colors duration-300">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {CERT_DATA.map(({ title, id, file, imgNum }) => (
      ...
      <section className="py-20 px-4 md:px-8 bg-yellow-50 dark:bg-[#121212] transition-colors duration-300">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-3">{t('categories.title')}</h2>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col sm:flex-row items-center justify-between mb-10 gap-4">
            <div className="text-center sm:text-left">
              <h2 className="text-3xl font-bold text-slate-900 dark:text-white">{t('featured.title')}</h2>
              <p className="text-slate-600 dark:text-slate-400 mt-2 text-sm">{t('featured.subtitle')}</p>
            </div>
            <Link
              href="/products"
      ...
      <section className="relative py-24 px-4 md:px-8 overflow-hidden bg-yellow-50 dark:bg-[#121212] transition-colors duration-300">
        ...
        <div className="relative max-w-2xl mx-auto text-center z-10">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white mb-4">{t('whatsapp_cta.title')}</h2>
          <p className="text-slate-600 dark:text-slate-400 mb-10 leading-relaxed text-lg">
            {t('whatsapp_cta.subtitle')}
          </p>
          <a
            href={`https://wa.me/${WA_NUMBER}`}
            target="_blank"
      ...
      <section className="py-20 px-4 md:px-8 bg-white dark:bg-[#18181b] transition-colors duration-300">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-slate-900 dark:text-white">{t('why_us.title')}</h2>
          </div>
