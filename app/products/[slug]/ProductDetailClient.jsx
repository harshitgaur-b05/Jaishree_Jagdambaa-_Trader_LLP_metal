...
export default function ProductDetailClient({ product, related, waLink }) {
    ...
    <div className="min-h-screen bg-white dark:bg-[#18181b] transition-colors duration-300">
      ...
      <div className="bg-slate-50 dark:bg-[#121212] border-b border-slate-200 dark:border-white/5 py-4 px-4 md:px-8 transition-colors duration-300">
        <div className="max-w-7xl mx-auto flex items-center gap-2 text-xs text-slate-400">
          <Link href="/" className="hover:text-[#10b981] transition-colors uppercase tracking-wider">{t('product_detail.home')}</Link>
          <span className="opacity-50">/</span>
          <Link href="/products" className="hover:text-[#10b981] transition-colors uppercase tracking-wider">{t('product_detail.products')}</Link>
          <span className="opacity-50">/</span>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          ...
          <div className="flex flex-col gap-5">
            ...
            {/* Description */}
            <div className="mt-4">
              <h2 className="text-sm font-bold text-[#10b981] uppercase tracking-widest mb-3">{t('product_detail.description')}</h2>
              ...
              <table className="w-full text-sm">
                <tbody>
                  {[
                    ...
                    [t('product_detail.sub_category'), product.subCategory],
                    [t('product_detail.type'), product.type],
                    [t('product_detail.dimension'), product.dimension],
                  ].map(([label, val]) => (
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-6 mt-auto">
              ...
              >
                💬 {t('product_detail.enquire_whatsapp')}
              </a>
        ...
        {related.length > 0 && (
          <div className="mt-24 pt-12 border-t border-slate-200 dark:border-white/5">
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-8">{t('product_detail.related_products')}</h2>
