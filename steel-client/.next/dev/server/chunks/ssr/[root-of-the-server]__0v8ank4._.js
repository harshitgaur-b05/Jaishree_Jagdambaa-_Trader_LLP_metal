...
"[project]/lib/whatsapp.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/components/EnquiryCart.jsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const EnquiryCartContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createContext"])(null);
function EnquiryCartProvider({ children }) {
    ...
    const isInCart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((id)=>cart.some((p)=>p.id === id), [
        cart
    ]);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(EnquiryCartContext.Provider, {
        value: {
            cart,
            addToCart,
            removeFromCart,
...
function useEnquiryCart() {
    const ctx = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useContext"])(EnquiryCartContext);
...
function EnquiryCart() {
    ...
    const waLink = cart.length > 0 ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$whatsapp$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getCartWALink"])(cart) : '#';
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0v8ank4._.js.map